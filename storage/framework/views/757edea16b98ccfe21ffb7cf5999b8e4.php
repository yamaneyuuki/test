...
<head>
  <meta charset="UTF-8">
  <link rel="stylesheet" href="<?php echo e(asset('css/employee_create.css')); ?>">
...
<body>
  ...
  <form id="employee-form" action="<?php echo e(route('employee.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
    <div class="area">
        <div class="area1">
...
<?php /**PATH C:\xampp\htdocs\Secure\resources\views/employee_create.blade.php ENDPATH**/ ?>